...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `max_connections` SMALLINT UNSIGNED NOT NULL DEFAULT 1,
  `max_mobile_connections` SMALLINT UNSIGNED NOT NULL DEFAULT 1 COMMENT 'max simultane telefoane mobile/tablet',
  `max_stb_connections` SMALLINT UNSIGNED NOT NULL DEFAULT 1 COMMENT 'max simultane Smart TV / STB',
